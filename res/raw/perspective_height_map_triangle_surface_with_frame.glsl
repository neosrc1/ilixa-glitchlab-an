...
////                vec4 col;
////                if (u_ColorScheme==0.0) col = texture2D(u_Tex0, proj0(squareCenter.xy));
////                else if (u_ColorScheme==100.0) col = texture2D(u_Tex0, proj0(intersection[0].xy));
////                else col = mix(texture2D(u_Tex0, proj0(squareCenter.xy)), texture2D(u_Tex0, proj0(intersection[0].xy)), u_ColorScheme*0.01);
